...
const storage = new Web3Storage({
  token:
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..Y7VCt1vcUFoUHrq_hZpB8mrgqiSTxqBWx6sIZ_aymjc",
});
  ...
  const handleClickOpen = async () => {
    ...
    try {
      ...
      const resFile = await axios({
        ...
        data: formData,
        headers: {
          pinata_api_key: "f92644f35e8b95d44d78",
          pinata_secret_api_key: "dfe33150166617f01bc61fe8802e1a1c90d2a55c1fc8eabedcae68097d7b5e08",
          "Content-Type": "multipart/form-data",
        },
      });
      console.log("File sent to IPFS: ", resFile.data.IpfsHash);
      ...
      await axios
        .post("http://127.0.0.1/post-face", formData2, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
        ...
        .catch((err) => {
          console.log("Post Face erroor:"+err);
          alert("Face not verified - Home,pease try again");
          window.location.reload();
        });
      ...
      let verified = false;
      await axios
        .post("http://127.0.0.1/check-face", formData3, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
